...
namespace CocoroConsole.Models.OtomeKairoApi
{
    ...
    public static class OtomeKairoCameraWatcherDefaults
    {
        public const double PollIntervalSeconds = 10;
        public const double MinWakeIntervalSeconds = 30;
        public const double MotionRatioThreshold = 0.2;
        public const int PixelDiffThreshold = 10;
        public const int ResizeWidth = 320;
    }
    ...
    public class OtomeKairoCameraWatcherDefinition
    {
        ...
        public double PollIntervalSeconds { get; set; } = OtomeKairoCameraWatcherDefaults.PollIntervalSeconds;

        [JsonPropertyName("min_wake_interval_seconds")]
        public double MinWakeIntervalSeconds { get; set; } = OtomeKairoCameraWatcherDefaults.MinWakeIntervalSeconds;

        [JsonPropertyName("motion_ratio_threshold")]
        public double MotionRatioThreshold { get; set; } = OtomeKairoCameraWatcherDefaults.MotionRatioThreshold;

        [JsonPropertyName("pixel_diff_threshold")]
        public int PixelDiffThreshold { get; set; } = OtomeKairoCameraWatcherDefaults.PixelDiffThreshold;

        [JsonPropertyName("resize_width")]
        public int ResizeWidth { get; set; } = OtomeKairoCameraWatcherDefaults.ResizeWidth;
    }
